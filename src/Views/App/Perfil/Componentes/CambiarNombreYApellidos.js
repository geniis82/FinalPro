...
const CambiarNombreYApellidos = () => {
    ...
    return (
        <ScrollView style={styles.container}>
            <TextCustom label={'Nombre'} id={'name'} value={user.name} onChange={handleOnChange} />
            <TextCustom label={'Apellidos'} id={'surname'} value={user.surname} onChange={handleOnChange} />
...
export default CambiarNombreYApellidos